...
@section('page')
    <div class="row mb10">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="@uri('glob/setting@accessgroup/add')">权限组添加</a></li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-8">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal ajaxform" id="form" method="post" action="@uri('glob/setting@accessgroup/doadd')">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">描述</label>
                            <div class="col-sm-10"><input type="text" value="" name="descr" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
