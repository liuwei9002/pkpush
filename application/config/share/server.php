...
//    "servers" => ['job'],
    "httpd" => [
        "server" => [
            ...
            'static_path' => APPLICATION_PATH . '/resource/static',
...
//        "diy"=>\App\Lib\Handle\ViewHandle::class,
                ...
                "page404"=>"page404",
                "bladex_ex"=>[
                    "datetime"=>\App\Lib\BladexEx\Datetime::class,
                    "diff"=>\App\Lib\BladexEx\Diff::class,
                    "option"=>\App\Lib\BladexEx\Option::class
                ],
                "static_version"=>20171102,
            ],
            "task_retry_count" => 2,
            "task_timeout"=>1,
            "serialization" => 1,
            ...
            'reactor_num' => 2,
            "task_worker_num" => 0,//task worker 数量
            "max_request"=>10000,
