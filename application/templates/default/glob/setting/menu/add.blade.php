...
@section('page')
    <div class="row mb10">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="@uri('glob/setting@menu/add')">添加菜单</a></li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-8">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal ajaxform" id="form" method="post" action="@uri('glob/setting@menu/doadd')">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="text" value="" name="name" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                                                ...
                                                <div class="panel-body">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr class=" odd" role="row" >
                                                            <td ><input type="radio" name="access_id" value="{{$v['id']}}">&nbsp;&nbsp;&nbsp;{{$v['name']}}</td>
                                                            <td >
                                                                <?php
                                                                if($v['ftype'] == 1){
                                                                    echo "菜单";
                                                        ...
                                                        @if($v['child'])
                                                            @foreach($v['child'] as $cv)
                                                                @if($cv['ftype'] != 3)
                                                                <tr class=" odd" role="row" >
                                                                    <td ><input type="radio" name="access_id" value="{{$cv['id']}}">&nbsp;&nbsp;&nbsp;{{$cv['name']}}</td>
                                                                    <td >
                                                                        <?php
                                                                        if($cv['ftype'] == 1){
                                                                            echo "菜单";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="text" value="" placeholder="fa fa-th-large" name="icon" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
