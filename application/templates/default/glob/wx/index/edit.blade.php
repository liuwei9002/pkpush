...
@section('page')
    <div class="row mb10">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="@uri('glob/wx@index/edit',['appName'=>$appName, "id"=>$id])">编辑菜单</a></li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal ajaxform" id="form" method="post" action="@uri('glob/wx@index/doedit',['appName'=>$appName, "id"=>$id])">
                        <div class="form-group"><label class="col-sm-2 control-label">名称</label>
                            <div class="col-sm-10"><input type="text" value="{{$info['fname']}}" name="fname" class="form-control"  data-required="true" >
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">数据(key/url)</label>
                            <div class="col-sm-10"><input type="text" value="{{$info['fdata']}}" name="fdata" class="form-control"></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group"><label class="col-sm-2 control-label">类型</label>
                            <div class="col-sm-10">
                                <select name="ftype" class="form-control m-b">
                                    <option value="view" @diff($info['ftype'], 'view')>view</option>
                                    <option value="click" @diff($info['ftype'], 'click')>click</option>
                                </select>
                            </div>
