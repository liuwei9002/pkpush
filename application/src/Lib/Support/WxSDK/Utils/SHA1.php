...
class SHA1
{
    ...
    static function getSHA1($token, $timestamp, $nonce, $encrypt_msg)
    {
        ...
        try {
            ...
            \Trensy\Support\Log::error('getSHA1 Error: ' . $e->getMessage());
            return FALSE;
        }
    }
    ...
    static function getSignature($token, $timestamp, $nonce)
    {
        ...
        try {
            ...
            \Trensy\Support\Log::error('getSignature Error: ' . $e->getMessage());
            return FALSE;
        }
    }
    ...
    static function get_jsapi_signature($jsapi_ticket, $nonceStr, $timestamp, $url)
    {
        ...
        try {
            ...
            \Trensy\Support\Log::error('get_jsapi_signature Error: ' . $e->getMessage());
            return FALSE;
        }
    }
